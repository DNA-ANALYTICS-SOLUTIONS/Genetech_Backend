package com.genetech.genetech_backend.security;
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/medical/lismedi").permitAll()
                        .requestMatchers("/createappointment").permitAll()
                        .requestMatchers("/listarappointment").permitAll()
                        .requestMatchers("/creatediagnostic").permitAll()
                        .requestMatchers("/listardiagnostic").permitAll()
